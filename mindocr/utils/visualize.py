...
def draw_texts_with_boxes(image: Union[str, np.array],
    ...
    '''
    font_path: path to ttf font file. If None, use a "better than nothing" defalut font in PIL (font_size can't be set in this case)
    ...
    for i, text in enumerate(texts):
        ...
        draw_point, fs = _get_draw_point_and_font_size(bboxes[i], font_size, text_inside_box=text_inside_box, img_h=img_h)
