...
def create_parser():
    ...
    parser.add_argument("--det_algorithm", type=str, default='DB++',
                        help='detection algorithm. Option: DB, DB++') # determine the network architecture
    ...
    parser.add_argument("--det_limit_side_len", type=float, default=736) # diff pp
    parser.add_argument("--det_limit_type", type=str, default='min') # diff pp
    ...
    parser.add_argument(
        "--vis_font_path", type=str, default="mindocr/utils/font/simfang.ttf")
    parser.add_argument("--drop_score", type=float, default=0.5)
    parser.add_argument("--rec_gt_path", type=str, default=None,
                        help='Path to ground truth labels of the recognition result')
